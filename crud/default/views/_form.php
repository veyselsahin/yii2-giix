        ...
        <p>
            <?php foreach ($safeAttributes as $attribute) {
                if(isset($generator->getTableSchema()->columns[$attribute])){
                    ...
                    if(!in_array($column->name,Yii::$app->params['globally_hidden_on_create']))
                    {
...
EOS;
    ...
    ?>";
        ...
        <?= "<?= " ?>Html::submitButton('<span class="glyphicon glyphicon-check"></span> '.($model->isNewRecord ? 'Oluştur' : 'Kaydet'), ['class' => $model->isNewRecord ?
