...
<div class="<?= Inflector::camel2id(StringHelper::basename($generator->modelClass), '-', true) ?>-view">
    ...
    <p class='pull-left'>
        <?= "<?= " ?>Html::a('<span class="glyphicon glyphicon-pencil"></span> Düzenle', ['update', <?= $urlParams ?>],
        ['class' => 'btn btn-info']) ?>
        <?= "<?= " ?>Html::a('<span class="glyphicon glyphicon-plus"></span> Yeni <?=
        Inflector::camel2words(
            StringHelper::basename($generator->modelClass)
        ) ?>', ['create'], ['class' => 'btn
        btn-success']) ?>
    ...
    echo "        <?= Html::a('<span class=\"glyphicon glyphicon-list\"></span> Listele', ['index'], ['class'=>'btn btn-default']) ?>\n";
    ...
    <?= "<?php " ?>echo Html::a('<span class="glyphicon glyphicon-trash"></span> Sil', ['delete', <?= $urlParams ?>],
    [
    'class' => 'btn btn-danger',
    'data-confirm' => Yii::t('app', 'Bu kaydı silmek istediğinize emin misiniz?'),
    'data-method' => 'post',
    ]); ?>
