...
$this->title = '<?= Inflector::camel2words(StringHelper::basename($generator->modelClass)) ?> Güncelle ' . $model-><?= $generator->getNameAttribute() ?> . '';
...
<div class="<?= Inflector::camel2id(StringHelper::basename($generator->modelClass),'-', true) ?>-update">
    ...
    <p>
        <?= "<?= " ?>Html::a('<span class="glyphicon glyphicon-eye-open"></span> Görüntüle', ['view', <?= $urlParams ?>], ['class' => 'btn btn-info']) ?>
    </p>
