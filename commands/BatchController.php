...
class BatchController extends Controller
{
     ...
     */
    public $tables = ['urun','urun_kategori','restoran','menu','menu_urun'];
    /**
     * @var string eg. `app_`
     */
    public $tablePrefix = '';
    ...
    public $modelDb = 'db';
    public $modelBaseClass = 'common\models\VysModel';
    public $crudControllerNamespace = 'backend\\controllers';
    public $crudViewPath = '@backend/views';
    public $crudPathPrefix = '';
    public $crudProviders = [];
    public $crudBaseControllerClass = 'common\controllers\VysController';
    /**
     * @inheritdoc
     */
        ...
        foreach ($this->tables AS $table) {
            ...
            $params = [
                ...
                'modelClass'         => isset($this->tableNameMap[$table]) ? $this->tableNameMap[$table] :
                    Inflector::camelize($table), // TODO: setting is not recognized in giix
